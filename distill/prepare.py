...
def get_args():
    ...
    py_parser.add_argument('--lrc_bert_gather_dp', action='store_true', help='计算对比损失且使用数据并行的时候将中间层输出合并,会增加通讯量和空间,但可以在数据并行的时候维持负例数量等于总batch size-1.依赖参数--fix_variable_num_choices')
    # annealing_kd
