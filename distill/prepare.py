...
def get_args():
    ...
    py_parser.add_argument('--tinybert_wo_final', action='store_true', help="不使用最后层,不适用于tinybert_only_emb_final,tinybert_custom_final")
    ...
    py_parser.add_argument('--tinybert_random_show', action='store_true', help="显示每次随机后的教师取层(不含最后层)")
    # minilmv2
