...
def get_model(args, model_type=None, multi_token=True, num_labels=None, spell_length=None, glm_wrap=None):
    ...
    if args.pretrained_bert:
        ...
        model = GLMModel(num_layers=args.num_layers,
                         ...
                         cross_layer_parameter_sharing=args.cross_layer_parameter_sharing,
                         )
...
def train_step(data_iterator, model, optimizer, lr_scheduler, args, timers, forward_step_func, mems=None,
    ...
    while True:
        ...
        lm_loss, mems, _ = forward_step_func(data_iterator, model, args, timers, mems, optimizer=optimizer, **kwargs)
        timers('forward').stop()
